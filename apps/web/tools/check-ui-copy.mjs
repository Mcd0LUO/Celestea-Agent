...
export const PENDING_MIGRATION = [
  ...
  'plugins/store.ts',
  'statusline/mode.ts',
  'statusline/permission.ts',
  'statusline/picker-list.ts',
  'statusline/picker-shared.ts',
  'statusline/picker.ts',
  'statusline/ring.ts',
  'statusline/session-model.ts',
  'theme.ts',
  'ui/archive/panel.ts',
  'ui/archive/rows.ts',
  ...
  'ui/messages.ts',
  'ui/mode/copy.ts',
  'ui/permissions/actions.ts',
  'ui/permissions/copy.ts',
  'ui/permissions/editor.ts',
  'ui/permissions/index.ts',
  'ui/permissions/list.ts',
  'ui/plugins/index.ts',
  'ui/preview/panel.ts',
  'ui/preview/renderers.ts',
  'ui/prompts.ts',
  'ui/providers/form.ts',
  'ui/providers/list.ts',
  'ui/providers/modelrow.ts',
  'ui/providers/panel.ts',
  'ui/providers/picker.ts',
  'ui/providers/rows.ts',
  'ui/providers.ts',
  'ui/question/card.ts',
