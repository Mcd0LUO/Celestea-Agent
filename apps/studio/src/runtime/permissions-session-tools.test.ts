...
/**
 * The frozen standard face of the production registry (W791/W804/W7: 13 names).
...
/** The execution-mode face (W791 M7): the mode fold, before any permission. */
const EXECUTION_FACE: readonly string[] = ["http_request", "process_control", "run_code", "send_message", "spawn_worker", "stop_worker", "worker_status"].sort();
